...
part of 'progress_migration_v7_to_v8_test.dart';
...
class $BodyMeasurementsTableV7Table extends BodyMeasurementsTableV7
    with TableInfo<$BodyMeasurementsTableV7Table, BodyMeasurementsTableV7Data> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $BodyMeasurementsTableV7Table(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<BodyMeasurementsTableV7Data> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  BodyMeasurementsTableV7Data map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return BodyMeasurementsTableV7Data(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  $BodyMeasurementsTableV7Table createAlias(String alias) {
    return $BodyMeasurementsTableV7Table(attachedDatabase, alias);
  }
}

class BodyMeasurementsTableV7Data extends DataClass
    implements Insertable<BodyMeasurementsTableV7Data> {
  final int id;
  final int profileId;
  ...
  final String? notes;
  const BodyMeasurementsTableV7Data({
    required this.id,
  ...
  BodyMeasurementsTableV7Companion toCompanion(bool nullToAbsent) {
    return BodyMeasurementsTableV7Companion(
      id: Value(id),
  ...
  factory BodyMeasurementsTableV7Data.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  BodyMeasurementsTableV7Data copyWith({
    int? id,
    int? profileId,
    DateTime? measuredAt,
    double? weightKg,
  ...
  BodyMeasurementsTableV7Data copyWithCompanion(
    BodyMeasurementsTableV7Companion data,
  ) {
    return BodyMeasurementsTableV7Data(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('BodyMeasurementsTableV7Data(')
          ..write('id: $id, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is BodyMeasurementsTableV7Data &&
          other.id == this.id &&
...
class BodyMeasurementsTableV7Companion
    extends UpdateCompanion<BodyMeasurementsTableV7Data> {
  final Value<int> id;
  ...
  const BodyMeasurementsTableV7Companion({
    this.id = const Value.absent(),
  ...
  BodyMeasurementsTableV7Companion.insert({
    this.id = const Value.absent(),
    ...
    this.notes = const Value.absent(),
       ...
       measuredAt = Value(measuredAt),
       weightKg = Value(weightKg);
  static Insertable<BodyMeasurementsTableV7Data> custom({
    Expression<int>? id,
  ...
  BodyMeasurementsTableV7Companion copyWith({
    Value<int>? id,
    Value<int>? profileId,
  ...
  @override
  String toString() {
    return (StringBuffer('BodyMeasurementsTableV7Companion(')
          ..write('id: $id, ')
          ..write('profileId: $profileId, ')
          ..write('measuredAt: $measuredAt, ')
          ..write('weightKg: $weightKg, ')
...
abstract class _$_SchemaV7Database extends GeneratedDatabase {
  _$_SchemaV7Database(QueryExecutor e) : super(e);
  $_SchemaV7DatabaseManager get managers => $_SchemaV7DatabaseManager(this);
  late final $AppSettingsTableTable appSettingsTable = $AppSettingsTableTable(
    this,
  );
  late final $UserProfilesTableTable userProfilesTable =
      $UserProfilesTableTable(this);
  late final $BodyMeasurementsTableV7Table bodyMeasurementsTableV7 =
      $BodyMeasurementsTableV7Table(this);
...
class $$AppSettingsTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $AppSettingsTableTable> {
...
final class $$UserProfilesTableTableReferences
  ...
  static MultiTypedResultKey<
    $BodyMeasurementsTableV7Table,
    List<BodyMeasurementsTableV7Data>
  >
  _bodyMeasurementsTableV7RefsTable(_$_SchemaV7Database db) =>
      MultiTypedResultKey.fromTable(
        db.bodyMeasurementsTableV7,
        aliasName: 'profili_utente__id__misurazioni_corporee__profile_id',
      );

  $$BodyMeasurementsTableV7TableProcessedTableManager
  get bodyMeasurementsTableV7Refs {
    final manager = $$BodyMeasurementsTableV7TableTableManager(
      $_db,
      $_db.bodyMeasurementsTableV7,
    ).filter((f) => f.profileId.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _bodyMeasurementsTableV7RefsTable($_db),
    );
  ...
  _camminateTableRefsTable(_$_SchemaV7Database db) =>
      MultiTypedResultKey.fromTable(
        db.camminateTable,
  ...
  >
  _pressureMeasurementsTableRefsTable(_$_SchemaV7Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  >
  _userEquipmentTableRefsTable(_$_SchemaV7Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  _allenamentiTableRefsTable(_$_SchemaV7Database db) =>
      MultiTypedResultKey.fromTable(
        db.allenamentiTable,
  ...
  >
  _sessioniAllenamentoTableRefsTable(_$_SchemaV7Database db) =>
      MultiTypedResultKey.fromTable(
...
class $$UserProfilesTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $UserProfilesTableTable> {
  ...
  Expression<bool> bodyMeasurementsTableV7Refs(
    Expression<bool> Function($$BodyMeasurementsTableV7TableFilterComposer f) f,
  ) {
    final $$BodyMeasurementsTableV7TableFilterComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.bodyMeasurementsTableV7,
          ...
          builder:
              ...
              }) => $$BodyMeasurementsTableV7TableFilterComposer(
                $db: $db,
                $table: $db.bodyMeasurementsTableV7,
...
class $$UserProfilesTableTableAnnotationComposer
  ...
  Expression<T> bodyMeasurementsTableV7Refs<T extends Object>(
    Expression<T> Function($$BodyMeasurementsTableV7TableAnnotationComposer a)
    f,
  ) {
    final $$BodyMeasurementsTableV7TableAnnotationComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.bodyMeasurementsTableV7,
          ...
          builder:
              (
                ...
                $addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer,
              }) => $$BodyMeasurementsTableV7TableAnnotationComposer(
                $db: $db,
                $table: $db.bodyMeasurementsTableV7,
                $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                joinBuilder: joinBuilder,
...
class $$UserProfilesTableTableTableManager
    extends
        RootTableManager<
          ...
          UserProfilesTableData,
          PrefetchHooks Function({
            bool bodyMeasurementsTableV7Refs,
    ...
    $UserProfilesTableTable table,
        ...
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({
                bodyMeasurementsTableV7Refs = false,
                ...
                return PrefetchHooks(
                  ...
                  explicitlyWatchedTables: [
                    if (bodyMeasurementsTableV7Refs) db.bodyMeasurementsTableV7,
                  ...
                  getPrefetchedDataCallback: (items) async {
                    return [
                      if (bodyMeasurementsTableV7Refs)
                        ...
                        >(
                          ...
                          referencedTable: $$UserProfilesTableTableReferences
                              ._bodyMeasurementsTableV7RefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$UserProfilesTableTableReferences(
                                db,
                                table,
                                p0,
                              ).bodyMeasurementsTableV7Refs,
...
typedef $$UserProfilesTableTableProcessedTableManager =
    ...
    >;
typedef $$BodyMeasurementsTableV7TableCreateCompanionBuilder =
    BodyMeasurementsTableV7Companion Function({
      Value<int> id,
      required int profileId,
      required DateTime measuredAt,
      required double weightKg,
...
typedef $$BodyMeasurementsTableV7TableUpdateCompanionBuilder =
    BodyMeasurementsTableV7Companion Function({
      Value<int> id,
      Value<int> profileId,
      Value<DateTime> measuredAt,
...
final class $$BodyMeasurementsTableV7TableReferences
    extends
        BaseReferences<
          _$_SchemaV7Database,
          $BodyMeasurementsTableV7Table,
          BodyMeasurementsTableV7Data
        > {
  $$BodyMeasurementsTableV7TableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );

  static $UserProfilesTableTable _profileIdTable(_$_SchemaV7Database db) => db
      .userProfilesTable
...
class $$BodyMeasurementsTableV7TableFilterComposer
    extends Composer<_$_SchemaV7Database, $BodyMeasurementsTableV7Table> {
  $$BodyMeasurementsTableV7TableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$BodyMeasurementsTableV7TableOrderingComposer
    extends Composer<_$_SchemaV7Database, $BodyMeasurementsTableV7Table> {
  $$BodyMeasurementsTableV7TableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$BodyMeasurementsTableV7TableAnnotationComposer
    extends Composer<_$_SchemaV7Database, $BodyMeasurementsTableV7Table> {
  $$BodyMeasurementsTableV7TableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$BodyMeasurementsTableV7TableTableManager
    extends
        RootTableManager<
          _$_SchemaV7Database,
          $BodyMeasurementsTableV7Table,
          ...
          $$BodyMeasurementsTableV7TableOrderingComposer,
          $$BodyMeasurementsTableV7TableAnnotationComposer,
          $$BodyMeasurementsTableV7TableCreateCompanionBuilder,
          $$BodyMeasurementsTableV7TableUpdateCompanionBuilder,
          (
            BodyMeasurementsTableV7Data,
            $$BodyMeasurementsTableV7TableReferences,
          ),
        ...
        > {
  $$BodyMeasurementsTableV7TableTableManager(
    _$_SchemaV7Database db,
    $BodyMeasurementsTableV7Table table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          updateCompanionCallback:
              ({
                ...
                Value<double?> rightCalfCm = const Value.absent(),
                Value<String?> notes = const Value.absent(),
              }) => BodyMeasurementsTableV7Companion(
                id: id,
                profileId: profileId,
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$BodyMeasurementsTableV7TableReferences(db, table, e),
                ),
              )
              .toList(),
...
typedef $$BodyMeasurementsTableV7TableProcessedTableManager =
    ProcessedTableManager<
      _$_SchemaV7Database,
      $BodyMeasurementsTableV7Table,
      BodyMeasurementsTableV7Data,
      ...
      $$BodyMeasurementsTableV7TableCreateCompanionBuilder,
      $$BodyMeasurementsTableV7TableUpdateCompanionBuilder,
      (BodyMeasurementsTableV7Data, $$BodyMeasurementsTableV7TableReferences),
      BodyMeasurementsTableV7Data,
      PrefetchHooks Function({bool profileId})
    >;
...
final class $$CamminateTableTableReferences
  ...
  static $UserProfilesTableTable _idProfiloTable(_$_SchemaV7Database db) => db
      .userProfilesTable
...
class $$CamminateTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $CamminateTableTable> {
  $$CamminateTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$PressureMeasurementsTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $PressureMeasurementsTableTable> {
  $$PressureMeasurementsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$UserEquipmentTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $UserEquipmentTableTable> {
  $$UserEquipmentTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
final class $$CategorieEserciziTableTableReferences
  ...
  _eserciziTableRefsTable(_$_SchemaV7Database db) =>
      MultiTypedResultKey.fromTable(
        db.eserciziTable,
...
class $$CategorieEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $CategorieEserciziTableTable> {
...
class $$GruppiMuscolariTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $GruppiMuscolariTableTable> {
...
final class $$EserciziTableTableReferences
  ...
  static MultiTypedResultKey<
    ...
    List<EserciziGruppiMuscolariTableData>
  >
  _eserciziGruppiMuscolariTableRefsTable(_$_SchemaV7Database db) =>
      MultiTypedResultKey.fromTable(
        db.eserciziGruppiMuscolariTable,
  ...
  >
  _attrezzatureEserciziTableRefsTable(_$_SchemaV7Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  >
  _immaginiEserciziTableRefsTable(_$_SchemaV7Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  >
  _progressioniComePrecedenteTable(_$_SchemaV7Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  static MultiTypedResultKey<
    ...
    List<ProgressioniEserciziTableData>
  >
  _progressioniComeSuccessivoTable(_$_SchemaV7Database db) =>
      MultiTypedResultKey.fromTable(
        db.progressioniEserciziTable,
        aliasName:
  ...
  >
  _alternativeComeOriginaleTable(_$_SchemaV7Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  static MultiTypedResultKey<
    ...
    List<AlternativeEserciziTableData>
  >
  _alternativeComeAlternativaTable(_$_SchemaV7Database db) =>
      MultiTypedResultKey.fromTable(
        db.alternativeEserciziTable,
        aliasName:
  ...
  >
  _allenamentiEserciziTableRefsTable(_$_SchemaV7Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  >
  _sessioniEserciziTableRefsTable(_$_SchemaV7Database db) =>
      MultiTypedResultKey.fromTable(
...
class $$EserciziTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $EserciziTableTable> {
  $$EserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
final class $$EserciziGruppiMuscolariTableTableReferences
  ...
  static $EserciziTableTable _idEsercizioTable(_$_SchemaV7Database db) => db
      .eserciziTable
...
class $$EserciziGruppiMuscolariTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $EserciziGruppiMuscolariTableTable> {
  $$EserciziGruppiMuscolariTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$AttrezzatureTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $AttrezzatureTableTable> {
...
final class $$AttrezzatureEserciziTableTableReferences
  ...
  static $AttrezzatureTableTable _idAttrezzaturaTable(_$_SchemaV7Database db) =>
...
class $$AttrezzatureEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $AttrezzatureEserciziTableTable> {
  $$AttrezzatureEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ImmaginiEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $ImmaginiEserciziTableTable> {
  $$ImmaginiEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ProgressioniEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $ProgressioniEserciziTableTable> {
  $$ProgressioniEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$AlternativeEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $AlternativeEserciziTableTable> {
  $$AlternativeEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$VersioniCatalogoTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $VersioniCatalogoTableTable> {
...
class $$AllenamentiTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $AllenamentiTableTable> {
  $$AllenamentiTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
final class $$AllenamentiEserciziTableTableReferences
  ...
  static $AllenamentiTableTable _idAllenamentoTable(_$_SchemaV7Database db) =>
...
class $$AllenamentiEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $AllenamentiEserciziTableTable> {
  $$AllenamentiEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$SessioniAllenamentoTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $SessioniAllenamentoTableTable> {
  $$SessioniAllenamentoTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$SessioniEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV7Database, $SessioniEserciziTableTable> {
  $$SessioniEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $_SchemaV7DatabaseManager {
  final _$_SchemaV7Database _db;
  $_SchemaV7DatabaseManager(this._db);
  ...
  $$BodyMeasurementsTableV7TableTableManager get bodyMeasurementsTableV7 =>
      $$BodyMeasurementsTableV7TableTableManager(
        _db,
        _db.bodyMeasurementsTableV7,
      );
