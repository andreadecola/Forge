...
part of 'weekly_plan_status_migration_v10_to_v11_test.dart';
...
class $AttivitaPianificateTableV10Table extends AttivitaPianificateTableV10
    with
        TableInfo<
          $AttivitaPianificateTableV10Table,
          AttivitaPianificateTableV10Data
        > {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $AttivitaPianificateTableV10Table(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<AttivitaPianificateTableV10Data> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  AttivitaPianificateTableV10Data map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return AttivitaPianificateTableV10Data(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  $AttivitaPianificateTableV10Table createAlias(String alias) {
    return $AttivitaPianificateTableV10Table(attachedDatabase, alias);
  }
}

class AttivitaPianificateTableV10Data extends DataClass
    implements Insertable<AttivitaPianificateTableV10Data> {
  final int id;
  final int idProfilo;
  ...
  const AttivitaPianificateTableV10Data({
    required this.id,
    required this.idProfilo,
  ...
  AttivitaPianificateTableV10Companion toCompanion(bool nullToAbsent) {
    return AttivitaPianificateTableV10Companion(
      id: Value(id),
      idProfilo: Value(idProfilo),
  ...
  factory AttivitaPianificateTableV10Data.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  AttivitaPianificateTableV10Data copyWith({
    int? id,
    int? idProfilo,
  ...
  AttivitaPianificateTableV10Data copyWithCompanion(
    AttivitaPianificateTableV10Companion data,
  ) {
    return AttivitaPianificateTableV10Data(
      id: data.id.present ? data.id.value : this.id,
      idProfilo: data.idProfilo.present ? data.idProfilo.value : this.idProfilo,
  ...
  @override
  String toString() {
    return (StringBuffer('AttivitaPianificateTableV10Data(')
          ..write('id: $id, ')
          ..write('idProfilo: $idProfilo, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is AttivitaPianificateTableV10Data &&
          other.id == this.id &&
          other.idProfilo == this.idProfilo &&
...
class AttivitaPianificateTableV10Companion
    extends UpdateCompanion<AttivitaPianificateTableV10Data> {
  final Value<int> id;
  final Value<int> idProfilo;
  ...
  const AttivitaPianificateTableV10Companion({
    this.id = const Value.absent(),
    this.idProfilo = const Value.absent(),
  ...
  AttivitaPianificateTableV10Companion.insert({
    this.id = const Value.absent(),
    required int idProfilo,
    ...
    this.idSessioneCamminata = const Value.absent(),
       ...
       dataCreazione = Value(dataCreazione),
       dataModifica = Value(dataModifica);
  static Insertable<AttivitaPianificateTableV10Data> custom({
    Expression<int>? id,
    Expression<int>? idProfilo,
  ...
  AttivitaPianificateTableV10Companion copyWith({
    Value<int>? id,
    Value<int>? idProfilo,
  ...
  @override
  String toString() {
    return (StringBuffer('AttivitaPianificateTableV10Companion(')
          ..write('id: $id, ')
          ..write('idProfilo: $idProfilo, ')
          ..write('dataPianificata: $dataPianificata, ')
          ..write('tipo: $tipo, ')
...
abstract class _$_SchemaV10Database extends GeneratedDatabase {
  _$_SchemaV10Database(QueryExecutor e) : super(e);
  $_SchemaV10DatabaseManager get managers => $_SchemaV10DatabaseManager(this);
  ...
  late final $AttivitaPianificateTableV10Table attivitaPianificateTableV10 =
      $AttivitaPianificateTableV10Table(this);
...
class $$AppSettingsTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $AppSettingsTableTable> {
...
final class $$UserProfilesTableTableReferences
  ...
  >
  _bodyMeasurementsTableRefsTable(_$_SchemaV10Database db) =>
  ...
  _camminateTableRefsTable(_$_SchemaV10Database db) =>
      MultiTypedResultKey.fromTable(
        db.camminateTable,
  ...
  >
  _pressureMeasurementsTableRefsTable(_$_SchemaV10Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  >
  _userEquipmentTableRefsTable(_$_SchemaV10Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  _allenamentiTableRefsTable(_$_SchemaV10Database db) =>
      MultiTypedResultKey.fromTable(
        db.allenamentiTable,
  ...
  >
  _sessioniAllenamentoTableRefsTable(_$_SchemaV10Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  static MultiTypedResultKey<
    $AttivitaPianificateTableV10Table,
    List<AttivitaPianificateTableV10Data>
  >
  _attivitaPianificateTableV10RefsTable(_$_SchemaV10Database db) =>
      MultiTypedResultKey.fromTable(
        db.attivitaPianificateTableV10,
        aliasName: 'profili_utente__id__attivita_pianificate__id_profilo',
      );

  $$AttivitaPianificateTableV10TableProcessedTableManager
  get attivitaPianificateTableV10Refs {
    final manager = $$AttivitaPianificateTableV10TableTableManager(
      $_db,
      $_db.attivitaPianificateTableV10,
    ).filter((f) => f.idProfilo.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _attivitaPianificateTableV10RefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$UserProfilesTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $UserProfilesTableTable> {
  ...
  Expression<bool> attivitaPianificateTableV10Refs(
    Expression<bool> Function(
      $$AttivitaPianificateTableV10TableFilterComposer f,
    )
    f,
  ) {
    final $$AttivitaPianificateTableV10TableFilterComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.attivitaPianificateTableV10,
          getReferencedColumn: (t) => t.idProfilo,
          builder:
              (
                joinBuilder, {
                $addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer,
              }) => $$AttivitaPianificateTableV10TableFilterComposer(
                $db: $db,
                $table: $db.attivitaPianificateTableV10,
                $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                joinBuilder: joinBuilder,
                $removeJoinBuilderFromRootComposer:
                    $removeJoinBuilderFromRootComposer,
...
class $$UserProfilesTableTableAnnotationComposer
  ...
  Expression<T> attivitaPianificateTableV10Refs<T extends Object>(
    Expression<T> Function(
      $$AttivitaPianificateTableV10TableAnnotationComposer a,
    )
    f,
  ) {
    final $$AttivitaPianificateTableV10TableAnnotationComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.attivitaPianificateTableV10,
          ...
          builder:
              (
                ...
                $addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer,
              }) => $$AttivitaPianificateTableV10TableAnnotationComposer(
                $db: $db,
                $table: $db.attivitaPianificateTableV10,
                $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                joinBuilder: joinBuilder,
    ...
    extends
        RootTableManager<
          ...
          PrefetchHooks Function({
            ...
            bool attivitaPianificateTableV10Refs,
          })
        > {
        ...
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({
                ...
                attivitaPianificateTableV10Refs = false,
              }) {
                return PrefetchHooks(
                  ...
                  explicitlyWatchedTables: [
                    ...
                    if (sessioniAllenamentoTableRefs)
                      db.sessioniAllenamentoTable,
                    if (attivitaPianificateTableV10Refs)
                      db.attivitaPianificateTableV10,
                  ],
                  addJoins: null,
                    ...
                    return [
                      ...
                      if (attivitaPianificateTableV10Refs)
                        ...
                        >(
                          currentTable: table,
                          referencedTable: $$UserProfilesTableTableReferences
                              ._attivitaPianificateTableV10RefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$UserProfilesTableTableReferences(
                                db,
                                table,
                                p0,
                              ).attivitaPianificateTableV10Refs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
                                (e) => e.idProfilo == item.id,
                              ),
...
final class $$BodyMeasurementsTableTableReferences
  ...
  static $UserProfilesTableTable _profileIdTable(_$_SchemaV10Database db) => db
      .userProfilesTable
...
class $$BodyMeasurementsTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $BodyMeasurementsTableTable> {
  $$BodyMeasurementsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
final class $$CamminateTableTableReferences
  ...
  static $UserProfilesTableTable _idProfiloTable(_$_SchemaV10Database db) => db
      .userProfilesTable
  ...
  get attivitaPianificateTableV10Refs {
    final manager =
        $$AttivitaPianificateTableV10TableTableManager(
          $_db,
          $_db.attivitaPianificateTableV10,
        ).filter(
...
class $$CamminateTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $CamminateTableTable> {
  $$CamminateTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    ...
    $CamminateTableTable table,
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({idProfilo = false, attivitaPianificateTableV10Refs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (attivitaPianificateTableV10Refs)
...
class $$PressureMeasurementsTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $PressureMeasurementsTableTable> {
  $$PressureMeasurementsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$UserEquipmentTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $UserEquipmentTableTable> {
  $$UserEquipmentTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
final class $$CategorieEserciziTableTableReferences
  ...
  _eserciziTableRefsTable(_$_SchemaV10Database db) =>
      MultiTypedResultKey.fromTable(
        db.eserciziTable,
...
class $$CategorieEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $CategorieEserciziTableTable> {
...
class $$GruppiMuscolariTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $GruppiMuscolariTableTable> {
...
final class $$EserciziTableTableReferences
  ...
  static MultiTypedResultKey<
    ...
    List<EserciziGruppiMuscolariTableData>
  >
  _eserciziGruppiMuscolariTableRefsTable(_$_SchemaV10Database db) =>
      MultiTypedResultKey.fromTable(
        db.eserciziGruppiMuscolariTable,
  ...
  >
  _attrezzatureEserciziTableRefsTable(_$_SchemaV10Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  >
  _immaginiEserciziTableRefsTable(_$_SchemaV10Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  >
  _progressioniComePrecedenteTable(_$_SchemaV10Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  static MultiTypedResultKey<
    ...
    List<ProgressioniEserciziTableData>
  >
  _progressioniComeSuccessivoTable(_$_SchemaV10Database db) =>
      MultiTypedResultKey.fromTable(
        db.progressioniEserciziTable,
        aliasName:
  ...
  >
  _alternativeComeOriginaleTable(_$_SchemaV10Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  static MultiTypedResultKey<
    ...
    List<AlternativeEserciziTableData>
  >
  _alternativeComeAlternativaTable(_$_SchemaV10Database db) =>
      MultiTypedResultKey.fromTable(
        db.alternativeEserciziTable,
        aliasName:
  ...
  >
  _allenamentiEserciziTableRefsTable(_$_SchemaV10Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  >
  _sessioniEserciziTableRefsTable(_$_SchemaV10Database db) =>
      MultiTypedResultKey.fromTable(
...
class $$EserciziTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $EserciziTableTable> {
  $$EserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
final class $$EserciziGruppiMuscolariTableTableReferences
  ...
  static $EserciziTableTable _idEsercizioTable(_$_SchemaV10Database db) => db
      .eserciziTable
...
class $$EserciziGruppiMuscolariTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $EserciziGruppiMuscolariTableTable> {
  $$EserciziGruppiMuscolariTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$AttrezzatureTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $AttrezzatureTableTable> {
...
final class $$AttrezzatureEserciziTableTableReferences
  ...
  static $AttrezzatureTableTable _idAttrezzaturaTable(
    _$_SchemaV10Database db,
...
class $$AttrezzatureEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $AttrezzatureEserciziTableTable> {
  $$AttrezzatureEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ImmaginiEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $ImmaginiEserciziTableTable> {
  $$ImmaginiEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ProgressioniEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $ProgressioniEserciziTableTable> {
  $$ProgressioniEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$AlternativeEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $AlternativeEserciziTableTable> {
  $$AlternativeEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$VersioniCatalogoTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $VersioniCatalogoTableTable> {
...
class $$AllenamentiTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $AllenamentiTableTable> {
  $$AllenamentiTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
final class $$AllenamentiEserciziTableTableReferences
  ...
  static $AllenamentiTableTable _idAllenamentoTable(_$_SchemaV10Database db) =>
...
class $$AllenamentiEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $AllenamentiEserciziTableTable> {
  $$AllenamentiEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
final class $$SessioniAllenamentoTableTableReferences
  ...
  static MultiTypedResultKey<
    ...
    List<AttivitaPianificateTableV10Data>
  >
  _attivitaPianificateTableV10RefsTable(
    _$_SchemaV10Database db,
  ) => MultiTypedResultKey.fromTable(
    db.attivitaPianificateTableV10,
    aliasName:
...
class $$SessioniAllenamentoTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $SessioniAllenamentoTableTable> {
  $$SessioniAllenamentoTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$SessioniEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV10Database, $SessioniEserciziTableTable> {
  $$SessioniEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
typedef $$SessioniEserciziTableTableProcessedTableManager =
    ...
    >;
typedef $$AttivitaPianificateTableV10TableCreateCompanionBuilder =
    AttivitaPianificateTableV10Companion Function({
      Value<int> id,
      required int idProfilo,
      required DateTime dataPianificata,
      required String tipo,
...
typedef $$AttivitaPianificateTableV10TableUpdateCompanionBuilder =
    AttivitaPianificateTableV10Companion Function({
      Value<int> id,
      Value<int> idProfilo,
      Value<DateTime> dataPianificata,
...
final class $$AttivitaPianificateTableV10TableReferences
    extends
        BaseReferences<
          _$_SchemaV10Database,
          $AttivitaPianificateTableV10Table,
          AttivitaPianificateTableV10Data
        > {
  $$AttivitaPianificateTableV10TableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
  ...
  static $AllenamentiTableTable _idAllenamentoTable(_$_SchemaV10Database db) =>
      db.allenamentiTable.createAlias(
        'attivita_pianificate__id_allenamento__allenamenti__id',
      );
  ...
  static $CamminateTableTable _idSessioneCamminataTable(
    _$_SchemaV10Database db,
...
class $$AttivitaPianificateTableV10TableFilterComposer
    extends Composer<_$_SchemaV10Database, $AttivitaPianificateTableV10Table> {
  $$AttivitaPianificateTableV10TableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$AttivitaPianificateTableV10TableOrderingComposer
    extends Composer<_$_SchemaV10Database, $AttivitaPianificateTableV10Table> {
  $$AttivitaPianificateTableV10TableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$AttivitaPianificateTableV10TableAnnotationComposer
    extends Composer<_$_SchemaV10Database, $AttivitaPianificateTableV10Table> {
  $$AttivitaPianificateTableV10TableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$AttivitaPianificateTableV10TableTableManager
    extends
        RootTableManager<
          _$_SchemaV10Database,
          $AttivitaPianificateTableV10Table,
          ...
          $$AttivitaPianificateTableV10TableOrderingComposer,
          $$AttivitaPianificateTableV10TableAnnotationComposer,
          $$AttivitaPianificateTableV10TableCreateCompanionBuilder,
          $$AttivitaPianificateTableV10TableUpdateCompanionBuilder,
          (
            AttivitaPianificateTableV10Data,
            $$AttivitaPianificateTableV10TableReferences,
          ),
  ...
  $$AttivitaPianificateTableV10TableTableManager(
    _$_SchemaV10Database db,
    $AttivitaPianificateTableV10Table table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int?> idSessioneAllenamento = const Value.absent(),
                Value<int?> idSessioneCamminata = const Value.absent(),
              }) => AttivitaPianificateTableV10Companion(
                id: id,
                idProfilo: idProfilo,
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$AttivitaPianificateTableV10TableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback:
...
typedef $$AttivitaPianificateTableV10TableProcessedTableManager =
    ProcessedTableManager<
      _$_SchemaV10Database,
      $AttivitaPianificateTableV10Table,
      AttivitaPianificateTableV10Data,
...
class $_SchemaV10DatabaseManager {
  final _$_SchemaV10Database _db;
  $_SchemaV10DatabaseManager(this._db);
  ...
  $$AttivitaPianificateTableV10TableTableManager
  get attivitaPianificateTableV10 =>
      $$AttivitaPianificateTableV10TableTableManager(
        _db,
        _db.attivitaPianificateTableV10,
      );
