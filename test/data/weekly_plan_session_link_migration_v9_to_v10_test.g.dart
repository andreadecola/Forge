...
part of 'weekly_plan_session_link_migration_v9_to_v10_test.dart';
...
class $AttivitaPianificateTableV9Table extends AttivitaPianificateTableV9
    with
        TableInfo<
          $AttivitaPianificateTableV9Table,
          AttivitaPianificateTableV9Data
        > {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $AttivitaPianificateTableV9Table(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<AttivitaPianificateTableV9Data> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  AttivitaPianificateTableV9Data map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return AttivitaPianificateTableV9Data(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  $AttivitaPianificateTableV9Table createAlias(String alias) {
    return $AttivitaPianificateTableV9Table(attachedDatabase, alias);
  }
}

class AttivitaPianificateTableV9Data extends DataClass
    implements Insertable<AttivitaPianificateTableV9Data> {
  final int id;
  final int idProfilo;
  ...
  final DateTime dataCreazione;
  final DateTime dataModifica;
  const AttivitaPianificateTableV9Data({
    required this.id,
    required this.idProfilo,
  ...
  AttivitaPianificateTableV9Companion toCompanion(bool nullToAbsent) {
    return AttivitaPianificateTableV9Companion(
      id: Value(id),
      idProfilo: Value(idProfilo),
  ...
  factory AttivitaPianificateTableV9Data.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  AttivitaPianificateTableV9Data copyWith({
    int? id,
    int? idProfilo,
  ...
  AttivitaPianificateTableV9Data copyWithCompanion(
    AttivitaPianificateTableV9Companion data,
  ) {
    return AttivitaPianificateTableV9Data(
      id: data.id.present ? data.id.value : this.id,
      idProfilo: data.idProfilo.present ? data.idProfilo.value : this.idProfilo,
  ...
  @override
  String toString() {
    return (StringBuffer('AttivitaPianificateTableV9Data(')
          ..write('id: $id, ')
          ..write('idProfilo: $idProfilo, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is AttivitaPianificateTableV9Data &&
          other.id == this.id &&
          other.idProfilo == this.idProfilo &&
...
class AttivitaPianificateTableV9Companion
    extends UpdateCompanion<AttivitaPianificateTableV9Data> {
  final Value<int> id;
  final Value<int> idProfilo;
  ...
  final Value<DateTime> dataCreazione;
  final Value<DateTime> dataModifica;
  const AttivitaPianificateTableV9Companion({
    this.id = const Value.absent(),
    this.idProfilo = const Value.absent(),
  ...
  AttivitaPianificateTableV9Companion.insert({
    this.id = const Value.absent(),
    required int idProfilo,
    ...
    required DateTime dataModifica,
       ...
       dataCreazione = Value(dataCreazione),
       dataModifica = Value(dataModifica);
  static Insertable<AttivitaPianificateTableV9Data> custom({
    Expression<int>? id,
    Expression<int>? idProfilo,
  ...
  AttivitaPianificateTableV9Companion copyWith({
    Value<int>? id,
    Value<int>? idProfilo,
  ...
  @override
  String toString() {
    return (StringBuffer('AttivitaPianificateTableV9Companion(')
          ..write('id: $id, ')
          ..write('idProfilo: $idProfilo, ')
          ..write('dataPianificata: $dataPianificata, ')
          ..write('tipo: $tipo, ')
...
abstract class _$_SchemaV9Database extends GeneratedDatabase {
  _$_SchemaV9Database(QueryExecutor e) : super(e);
  $_SchemaV9DatabaseManager get managers => $_SchemaV9DatabaseManager(this);
  ...
  late final $AttivitaPianificateTableV9Table attivitaPianificateTableV9 =
      $AttivitaPianificateTableV9Table(this);
...
class $$AppSettingsTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $AppSettingsTableTable> {
...
final class $$UserProfilesTableTableReferences
  ...
  >
  _bodyMeasurementsTableRefsTable(_$_SchemaV9Database db) =>
  ...
  _camminateTableRefsTable(_$_SchemaV9Database db) =>
      MultiTypedResultKey.fromTable(
        db.camminateTable,
  ...
  >
  _pressureMeasurementsTableRefsTable(_$_SchemaV9Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  >
  _userEquipmentTableRefsTable(_$_SchemaV9Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  _allenamentiTableRefsTable(_$_SchemaV9Database db) =>
      MultiTypedResultKey.fromTable(
        db.allenamentiTable,
  ...
  >
  _sessioniAllenamentoTableRefsTable(_$_SchemaV9Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  static MultiTypedResultKey<
    $AttivitaPianificateTableV9Table,
    List<AttivitaPianificateTableV9Data>
  >
  _attivitaPianificateTableV9RefsTable(_$_SchemaV9Database db) =>
      MultiTypedResultKey.fromTable(
        db.attivitaPianificateTableV9,
        aliasName: 'profili_utente__id__attivita_pianificate__id_profilo',
      );

  $$AttivitaPianificateTableV9TableProcessedTableManager
  get attivitaPianificateTableV9Refs {
    final manager = $$AttivitaPianificateTableV9TableTableManager(
      $_db,
      $_db.attivitaPianificateTableV9,
    ).filter((f) => f.idProfilo.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _attivitaPianificateTableV9RefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$UserProfilesTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $UserProfilesTableTable> {
  ...
  Expression<bool> attivitaPianificateTableV9Refs(
    Expression<bool> Function($$AttivitaPianificateTableV9TableFilterComposer f)
    f,
  ) {
    final $$AttivitaPianificateTableV9TableFilterComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.attivitaPianificateTableV9,
          getReferencedColumn: (t) => t.idProfilo,
          builder:
              (
                joinBuilder, {
                $addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer,
              }) => $$AttivitaPianificateTableV9TableFilterComposer(
                $db: $db,
                $table: $db.attivitaPianificateTableV9,
                $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                joinBuilder: joinBuilder,
                $removeJoinBuilderFromRootComposer:
                    $removeJoinBuilderFromRootComposer,
...
class $$UserProfilesTableTableAnnotationComposer
  ...
  Expression<T> attivitaPianificateTableV9Refs<T extends Object>(
    Expression<T> Function(
      $$AttivitaPianificateTableV9TableAnnotationComposer a,
    )
    f,
  ) {
    final $$AttivitaPianificateTableV9TableAnnotationComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.attivitaPianificateTableV9,
          ...
          builder:
              (
                ...
                $addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer,
              }) => $$AttivitaPianificateTableV9TableAnnotationComposer(
                $db: $db,
                $table: $db.attivitaPianificateTableV9,
                $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                joinBuilder: joinBuilder,
    ...
    extends
        RootTableManager<
          ...
          PrefetchHooks Function({
            ...
            bool attivitaPianificateTableV9Refs,
          })
        > {
        ...
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({
                ...
                attivitaPianificateTableV9Refs = false,
              }) {
                return PrefetchHooks(
                  ...
                  explicitlyWatchedTables: [
                    ...
                    if (sessioniAllenamentoTableRefs)
                      db.sessioniAllenamentoTable,
                    if (attivitaPianificateTableV9Refs)
                      db.attivitaPianificateTableV9,
                  ],
                  addJoins: null,
                    ...
                    return [
                      ...
                      if (attivitaPianificateTableV9Refs)
                        ...
                        >(
                          currentTable: table,
                          referencedTable: $$UserProfilesTableTableReferences
                              ._attivitaPianificateTableV9RefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$UserProfilesTableTableReferences(
                                db,
                                table,
                                p0,
                              ).attivitaPianificateTableV9Refs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
                                (e) => e.idProfilo == item.id,
                              ),
...
final class $$BodyMeasurementsTableTableReferences
  ...
  static $UserProfilesTableTable _profileIdTable(_$_SchemaV9Database db) => db
      .userProfilesTable
...
class $$BodyMeasurementsTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $BodyMeasurementsTableTable> {
  $$BodyMeasurementsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
final class $$CamminateTableTableReferences
  ...
  static $UserProfilesTableTable _idProfiloTable(_$_SchemaV9Database db) => db
      .userProfilesTable
...
class $$CamminateTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $CamminateTableTable> {
  $$CamminateTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$PressureMeasurementsTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $PressureMeasurementsTableTable> {
  $$PressureMeasurementsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$UserEquipmentTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $UserEquipmentTableTable> {
  $$UserEquipmentTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
final class $$CategorieEserciziTableTableReferences
  ...
  _eserciziTableRefsTable(_$_SchemaV9Database db) =>
      MultiTypedResultKey.fromTable(
        db.eserciziTable,
...
class $$CategorieEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $CategorieEserciziTableTable> {
...
class $$GruppiMuscolariTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $GruppiMuscolariTableTable> {
...
final class $$EserciziTableTableReferences
  ...
  static MultiTypedResultKey<
    ...
    List<EserciziGruppiMuscolariTableData>
  >
  _eserciziGruppiMuscolariTableRefsTable(_$_SchemaV9Database db) =>
      MultiTypedResultKey.fromTable(
        db.eserciziGruppiMuscolariTable,
  ...
  >
  _attrezzatureEserciziTableRefsTable(_$_SchemaV9Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  >
  _immaginiEserciziTableRefsTable(_$_SchemaV9Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  >
  _progressioniComePrecedenteTable(_$_SchemaV9Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  static MultiTypedResultKey<
    ...
    List<ProgressioniEserciziTableData>
  >
  _progressioniComeSuccessivoTable(_$_SchemaV9Database db) =>
      MultiTypedResultKey.fromTable(
        db.progressioniEserciziTable,
        aliasName:
  ...
  >
  _alternativeComeOriginaleTable(_$_SchemaV9Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  static MultiTypedResultKey<
    ...
    List<AlternativeEserciziTableData>
  >
  _alternativeComeAlternativaTable(_$_SchemaV9Database db) =>
      MultiTypedResultKey.fromTable(
        db.alternativeEserciziTable,
        aliasName:
  ...
  >
  _allenamentiEserciziTableRefsTable(_$_SchemaV9Database db) =>
      MultiTypedResultKey.fromTable(
  ...
  >
  _sessioniEserciziTableRefsTable(_$_SchemaV9Database db) =>
      MultiTypedResultKey.fromTable(
...
class $$EserciziTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $EserciziTableTable> {
  $$EserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
final class $$EserciziGruppiMuscolariTableTableReferences
  ...
  static $EserciziTableTable _idEsercizioTable(_$_SchemaV9Database db) => db
      .eserciziTable
...
class $$EserciziGruppiMuscolariTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $EserciziGruppiMuscolariTableTable> {
  $$EserciziGruppiMuscolariTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$AttrezzatureTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $AttrezzatureTableTable> {
...
final class $$AttrezzatureEserciziTableTableReferences
  ...
  static $AttrezzatureTableTable _idAttrezzaturaTable(_$_SchemaV9Database db) =>
...
class $$AttrezzatureEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $AttrezzatureEserciziTableTable> {
  $$AttrezzatureEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ImmaginiEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $ImmaginiEserciziTableTable> {
  $$ImmaginiEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ProgressioniEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $ProgressioniEserciziTableTable> {
  $$ProgressioniEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$AlternativeEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $AlternativeEserciziTableTable> {
  $$AlternativeEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$VersioniCatalogoTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $VersioniCatalogoTableTable> {
...
class $$AllenamentiTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $AllenamentiTableTable> {
  $$AllenamentiTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
final class $$AllenamentiEserciziTableTableReferences
  ...
  static $AllenamentiTableTable _idAllenamentoTable(_$_SchemaV9Database db) =>
...
class $$AllenamentiEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $AllenamentiEserciziTableTable> {
  $$AllenamentiEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$SessioniAllenamentoTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $SessioniAllenamentoTableTable> {
  $$SessioniAllenamentoTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$SessioniEserciziTableTableFilterComposer
    extends Composer<_$_SchemaV9Database, $SessioniEserciziTableTable> {
  $$SessioniEserciziTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
typedef $$SessioniEserciziTableTableProcessedTableManager =
    ...
    >;
typedef $$AttivitaPianificateTableV9TableCreateCompanionBuilder =
    AttivitaPianificateTableV9Companion Function({
      Value<int> id,
      required int idProfilo,
      required DateTime dataPianificata,
      required String tipo,
...
typedef $$AttivitaPianificateTableV9TableUpdateCompanionBuilder =
    AttivitaPianificateTableV9Companion Function({
      Value<int> id,
      Value<int> idProfilo,
      Value<DateTime> dataPianificata,
...
final class $$AttivitaPianificateTableV9TableReferences
    extends
        BaseReferences<
          _$_SchemaV9Database,
          $AttivitaPianificateTableV9Table,
          AttivitaPianificateTableV9Data
        > {
  $$AttivitaPianificateTableV9TableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
...
class $$AttivitaPianificateTableV9TableFilterComposer
    extends Composer<_$_SchemaV9Database, $AttivitaPianificateTableV9Table> {
  $$AttivitaPianificateTableV9TableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$AttivitaPianificateTableV9TableOrderingComposer
    extends Composer<_$_SchemaV9Database, $AttivitaPianificateTableV9Table> {
  $$AttivitaPianificateTableV9TableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$AttivitaPianificateTableV9TableAnnotationComposer
    extends Composer<_$_SchemaV9Database, $AttivitaPianificateTableV9Table> {
  $$AttivitaPianificateTableV9TableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$AttivitaPianificateTableV9TableTableManager
    extends
        RootTableManager<
          _$_SchemaV9Database,
          $AttivitaPianificateTableV9Table,
          ...
          $$AttivitaPianificateTableV9TableOrderingComposer,
          $$AttivitaPianificateTableV9TableAnnotationComposer,
          $$AttivitaPianificateTableV9TableCreateCompanionBuilder,
          $$AttivitaPianificateTableV9TableUpdateCompanionBuilder,
          (
            AttivitaPianificateTableV9Data,
            $$AttivitaPianificateTableV9TableReferences,
          ),
          AttivitaPianificateTableV9Data,
          PrefetchHooks Function({bool idProfilo, bool idAllenamento})
        > {
  $$AttivitaPianificateTableV9TableTableManager(
    _$_SchemaV9Database db,
    $AttivitaPianificateTableV9Table table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          updateCompanionCallback:
              ({
                ...
                Value<DateTime> dataCreazione = const Value.absent(),
                Value<DateTime> dataModifica = const Value.absent(),
              }) => AttivitaPianificateTableV9Companion(
                id: id,
                idProfilo: idProfilo,
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$AttivitaPianificateTableV9TableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({idProfilo = false, idAllenamento = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins:
...
typedef $$AttivitaPianificateTableV9TableProcessedTableManager =
    ProcessedTableManager<
      _$_SchemaV9Database,
      $AttivitaPianificateTableV9Table,
      AttivitaPianificateTableV9Data,
...
class $_SchemaV9DatabaseManager {
  final _$_SchemaV9Database _db;
  $_SchemaV9DatabaseManager(this._db);
  ...
  $$AttivitaPianificateTableV9TableTableManager
  get attivitaPianificateTableV9 =>
      $$AttivitaPianificateTableV9TableTableManager(
        _db,
        _db.attivitaPianificateTableV9,
      );
